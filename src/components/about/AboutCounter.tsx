      ...
      <Container>
        <div className="text-center pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-14 ">
            ...
            <div>
              <h1 className="lg:text-7xl text-[2.813rem] Mulish-semibold text-red-600 pb-6"> <Counter value={575}/></h1>
              <p>
                The standard chunk of Lorem Ipsum used since the 1500s is
                reproduced below for those.
              </p>
            ...
            <div>
              <h1 className="lg:text-7xl text-[2.813rem] Mulish-semibold text-red-600 pb-6"><Counter value={69} /></h1>
              <p>
                The standard chunk of Lorem Ipsum used since the 1500s is
                reproduced below for those.
              </p>
