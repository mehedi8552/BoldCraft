            ...
            {ServiceData.map((data) => {
              return (
                <motion.div
                  ...
                  className="cursor-pointer text-center hover:shadow-lg p-4 py-16 rounded-md space-x-2 space-y-4 hover:bg-gradient-to-r hover:from-red-500 hover:to-pink-500 group  bg-slate-100 dark:bg-[#1F1F25] dark:border dark:border-slate-100"
                >
