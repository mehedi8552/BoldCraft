    ...
    <Container>
      <div className="text-center lg:pt-20 pt-10 lg:pb-32 pb-16">
        <div className="text-center space-y-2 lg:pb-10 lg:space-y-4 ">
          ...
          <p className="Mulish-bold text-3xl lg:text-[3.375rem] text-black pb-12 dark:text-white">Our More Projects</p>
        </div>
        <section className="flex flex-col md:flex-row   gap-6">
          <div className="md:w-1/2 ">
            <div className="space-y-6">
              ...
              <div className="text-center space-y-2">
                <h1 className="Mulish-semibold text-2xl dark:text-white">Design Management</h1>
                <p className=" Mulish-medium text-base">
                  Technique
                </p>
              </div>
            </div>
          ...
          <div className="md:w-1/2  ">
            <div className="space-y-6">
              ...
              <div className="text-center space-y-2">
                <h1 className="Mulish-semibold text-2xl dark:text-white">Plan Analysis</h1>
                <p className=" Mulish-medium text-base">Planing</p>
              </div>
            </div>
          </div>
        </section>
